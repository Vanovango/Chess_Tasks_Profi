...
TASK_THEME_FIGURES = {
    ...
    'Путь ладьи 1-2-3 с перегородками': [6, 7],  # 6 - number, 7 - cross
...
FIGURE_TYPES = {
    ...
    3: {  # Стена
        ...
        'type': 'wall',
        'symbol': '─',
        'description': 'Стена (линия на ребре)',
    ...
    6: {  # Цифра
        ...
        'type': 'number',
        'symbol': '№',
        'description': 'Цифра (при удалении сохраняет свое значение для повторного использования)'
    },
    7: {  # Крест
        'name': 'Крест',
        'color': '#000000',
        'type': 'cross',
        'symbol': '+',
        'description': 'Крест (две пересекающиеся линии)'
    },
    8: {  # Закрашенная клетка
        'name': 'Закрашенная клетка',
        'color': '#000000',
        'type': 'filled_cell',
        'symbol': '■',
        'description': 'Закрашенная клетка'
    }
}
